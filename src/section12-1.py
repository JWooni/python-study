...
conn = sqlite3.connect('C:/Users/yeo_r/jw/python-basic/resource/database.db', isolation_level=None)
...
# 데이터 삽입
# c.execute("INSERT INTO users VALUES(1, 'Kim', 'jwooni@google.com','010-0000-0000', \
# 'JWooni.com', ?)", (nowDatetime,))

# c.execute("INSERT INTO users(id, username, email, phone, website, regDate) VALUES (?, ?, ?, ?, ?, ?)",
# (2,'Park', 'Park@naver.com','010-1234-5678','park.com', nowDatetime))
